...
const SKIP_BUTTON_SELECTORS: string[] = [
    ".ytp-ad-skip-button",
 ...
 */
function tryClickSkipButton(): boolean {
 ...
 */
function dismissAdOverlays(): void {
    const overlayCloseButtons: string[] = [
